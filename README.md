...
[API Docs](docs/README.md) - generated by [typedoc](http://typedoc.org/).
...
Manipulate existing instances of [`Node`](interfaces/node.md) with [functions](docs/README.md#functions).
Every function takes a [`Node`](interfaces/node.md) (usually a root note) instance as the first argument.

The following snippet works identical to the object-oriented example.
