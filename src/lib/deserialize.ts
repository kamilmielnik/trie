 ...
 *
 * @param serialized - String with value returned by {@link (README.md)#serialize | `serialize`}.
 * @returns Instance of a root [`Node`](interfaces/node.md) of deserialized string.
 */
