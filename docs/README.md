...
*Defined in [lib/traverse.ts:5](https://github.com/kamilmielnik/trie/blob/master/src/lib/traverse.ts#L5)*
...
*Defined in [lib/serialize.ts:4](https://github.com/kamilmielnik/trie/blob/master/src/lib/serialize.ts#L4)*
